...
if (isset($_POST['loginbtn'])) {
    ...
    $sql = "SELECT * FROM advisor WHERE email = '$u_signin_email' AND password = '$u_signin_pass'";
    ...
    if ($numrows == 0) {
        ...
        echo "<script>window.location='/course/advisor/advisor_feed.php'</script>";
    }
}
