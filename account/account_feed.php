...
<div class="container">
    ...
    <div class="feed-container">
       ...
       <button class="extra-btn" onclick=gotoapplies()>Check New Applies</button></div>
       <div class="box">
       <img src="../media/h.jpg" alt=""class="feed-img"> 
       <button class="extra-btn" onclick=gotohistory()>Confirmation History</button></div>
       <div class="box">
       <img src="../media/account.avif" alt=""class="feed-img">
       <button class="extra-btn" onclick=gotoaccounts()>Check Accounts</button></div>
    </div>
</div>
